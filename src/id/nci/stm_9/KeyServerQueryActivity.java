...
public class KeyServerQueryActivity extends SherlockFragmentActivity {
    ...
    public static final String ACTION_LOOK_UP_KEY_ID = "id.nci.stm_9" + ".action." + "LOOK_UP_KEY_ID";

    public static final String ACTION_LOOK_UP_KEY_ID_AND_RETURN = "id.nci.stm_9" + ".action."
