...
import id.nci.stm_9.SetPassphraseDialogFragment;
import id.nci.stm_9.KeyEditor;
import id.nci.stm_9.SectionView;
import id.nci.stm_9.UserIdEditor;
...
public class EditKeyActivity extends SherlockFragmentActivity {
    ...
    public static final String ACTION_CREATE_KEY = "id.nci.stm_9" + ".action." + "CREATE_KEY";
    public static final String ACTION_EDIT_KEY = "id.nci.stm_9" + ".action." + "EDIT_KEY";
...
//                                mKeysUsages.add(Id.choice.usage.encrypt_only);
    ...
    private void showPassphraseDialog(final long masterKeyId, final boolean masterCanSign) {
        ...
        try {
            ...
            Log.d("stm-9", "No passphrase for this secret key!");
