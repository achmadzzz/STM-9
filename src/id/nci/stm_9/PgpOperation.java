...
//        if (signatureKeyId != Id.key.none) {
        ...
        if (encryptionKeyIds.length == 0) {
            ...
            Log.d("stm-9", "encryptionKeyIds length is 0 -> symmetric encryption");
    ...
    public Bundle decryptAndVerify(String passphrase, boolean assumeSymmetric) throws IOException,
        ...
        if (assumeSymmetric) {
            ...
            PBEDataDecryptorFactory decryptorFactory = new JcePBEDataDecryptorFactoryBuilder(
                    digestCalcProvider).setProvider(BouncyCastleProvider.PROVIDER_NAME).build(
