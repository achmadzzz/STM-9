...
import id.nci.stm_9.KeychainContract.KeyRings;
import id.nci.stm_9.KeychainContract.UserIds;
import id.nci.stm_9.KeyListAdapter;
...
//        mAdapter = new KeyListAdapter(mKeyListPublicActivity, null, Id.type.public_key);
        mAdapter = new KeyListAdapter(mKeyListPublicActivity, null, 0x21070001);
...
//        menu.add(0, Id.menu.update, 1, R.string.menu_update_key);
        menu.add(0, 0x21070004, 1, R.string.menu_update_key);
//        menu.add(0, Id.menu.signKey, 2, R.string.menu_sign_key);
        menu.add(0, 0x21070009, 2, R.string.menu_sign_key);
//        menu.add(0, Id.menu.exportToServer, 3, R.string.menu_export_key_to_server);
        menu.add(0, 0x21070005, 3, R.string.menu_export_key_to_server);
//        menu.add(0, Id.menu.share, 6, R.string.menu_share);
        menu.add(0, 0x21070006, 6, R.string.menu_share);
//        menu.add(0, Id.menu.share_qr_code, 7, R.string.menu_share_qr_code);
        menu.add(0, 0x21070007, 7, R.string.menu_share_qr_code);
//        menu.add(0, Id.menu.share_nfc, 8, R.string.menu_share_nfc);
        menu.add(0, 0x21070008, 8, R.string.menu_share_nfc);
