...
//        case Id.choice.algorithm.dsa: {
        case 0x21070001: {
            keyGen = KeyPairGenerator.getInstance("DSA", BouncyCastleProvider.PROVIDER_NAME);
...
//        case Id.choice.algorithm.elgamal: {
        case 0x21070002: {
            ...
            keyGen = KeyPairGenerator.getInstance("ElGamal", BouncyCastleProvider.PROVIDER_NAME);
    ...
    public void changeSecretKeyPassphrase(PGPSecretKeyRing keyRing, String oldPassPhrase,
        ...
        PGPSecretKeyRing newKeyRing = PGPSecretKeyRing.copyWithNewPassword(
                ...
                new JcePBESecretKeyDecryptorBuilder(new JcaPGPDigestCalculatorProviderBuilder()
                        .setProvider(BouncyCastleProvider.PROVIDER_NAME).build()).setProvider(
                        BouncyCastleProvider.PROVIDER_NAME).build(oldPassPhrase.toCharArray()),
...
//        boolean canSign = (usageId == Id.choice.usage.sign_only || usageId == Id.choice.usage.sign_and_encrypt);
        boolean canSign = (usageId == 0x21070002 || usageId == 0x21070003);
//        boolean canEncrypt = (usageId == Id.choice.usage.encrypt_only || usageId == Id.choice.usage.sign_and_encrypt);
        boolean canEncrypt = (usageId == 0x21070002 || usageId == 0x21070003);
...
//            canSign = (usageId == Id.choice.usage.sign_only || usageId == Id.choice.usage.sign_and_encrypt);
            canSign = (usageId == 0x21070001 || usageId == 0x21070003);
//            canEncrypt = (usageId == Id.choice.usage.encrypt_only || usageId == Id.choice.usage.sign_and_encrypt);
            canEncrypt = (usageId == 0x21070002 || usageId == 0x21070003);
            if (canSign) {
