...
//        mKeyType = Id.type.public_key;
        ...
        mExportFilename = Environment.getExternalStorageDirectory() + "/STM-9" + "/pubexport.asc";
    }
...
//        menu.add(1, Id.menu.option.key_server, 1, R.string.menu_key_server)
        menu.add(1, 0x21070011, 1, R.string.menu_key_server)
...
//        menu.add(1, Id.menu.option.import_from_qr_code, 2, R.string.menu_import_from_qr_code)
        menu.add(1, 0x21070021, 2, R.string.menu_import_from_qr_code)
               .setShowAsAction(
                        MenuItem.SHOW_AS_ACTION_IF_ROOM | MenuItem.SHOW_AS_ACTION_WITH_TEXT);
//        menu.add(1, Id.menu.option.import_from_nfc, 3, R.string.menu_import_from_nfc)
        menu.add(1, 0x21070022, 3, R.string.menu_import_from_nfc)
                .setShowAsAction(
                        MenuItem.SHOW_AS_ACTION_IF_ROOM | MenuItem.SHOW_AS_ACTION_WITH_TEXT);
