...
public class KeyEditor extends LinearLayout implements Editor, OnClickListener {
    ...
    protected void onFinishInflate() {
        ...
        Choice choices[] = {
                new Choice(0x21070001, getResources().getString(
                        R.string.choice_sign_only)),
                new Choice(0x21070002, getResources().getString(
                        R.string.choice_encrypt_only)),
                new Choice(0x21070003, getResources().getString(
    ...
    public void setValue(PGPSecretKey key, boolean isMasterKey, int usage) {
        ...
        if (!isElGamalKey) {
            choices.add(new Choice(0x21070001, getResources().getString(
                    R.string.choice_sign_only)));
        }
        if (!mIsMasterKey && !isDSAKey) {
            choices.add(new Choice(0x21070002, getResources().getString(
                    R.string.choice_encrypt_only)));
        }
        if (!isElGamalKey && !isDSAKey) {
            choices.add(new Choice(0x21070003, getResources().getString(
                    R.string.choice_sign_and_encrypt)));
        }
