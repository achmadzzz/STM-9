...
public class PassphraseCacheService extends Service {
    ...
    public static final String ACTION_PASSPHRASE_CACHE_ADD = "id.nci.stm_9" + ".action."
            + "PASSPHRASE_CACHE_ADD";
    public static final String ACTION_PASSPHRASE_CACHE_GET = "id.nci.stm_9" + ".action."
            + "PASSPHRASE_CACHE_GET";

    public static final String BROADCAST_ACTION_PASSPHRASE_CACHE_SERVICE = "id.nci.stm_9" + ".action."
